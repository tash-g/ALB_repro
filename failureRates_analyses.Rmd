...
#png(file = "Figures/FIGURE1.png", width = 10.2, height = 10, units = "in", res = 600)
...
bbal_incub.fixef_MS <- bbal_incub.fixef_MS[-(11:14),]
...
bbal_brooding.fixef_MS <- bbal_brooding.fixef_MS[-(11:14),]
...
waal_incub.fixef_MS <- waal_incub.fixef_MS[-(11:14),]
...
waal_brooding.fixef_MS <- waal_brooding.fixef_MS[-(11:14),]
...
png(file = "Figures/presentation_2A.png", width = 6, height = 5, units = "in", res = 300)
bbal_incub.cond_plot.median_trip.days
dev.off()

png(file = "Figures/presentation_2B.png", width = 6, height = 5, units = "in", res = 300)
bbal_brooding.cond_plot.median_trip.days
dev.off()


png(file = "Figures/presentation_2C.png", width = 6, height = 5, units = "in", res = 300)
...
png(file = "Figures/presentation_3A.png", width = 6, height = 5, units = "in", res = 300)
waal_incub.cond_plot.diff_var.days +
              labs(y = "Incubation \nP|Breeding success")
dev.off()

png(file = "Figures/presentation_3B.png", width = 6, height = 5, units = "in", res = 300)
waal_brooding.cond_plot.median_trip.days
dev.off()


png(file = "Figures/presentation_3C.png", width = 6, height = 5, units = "in", res = 300)
...
bbal_incub_bi.T_ROPE <- bbal_incub.fixef$prop_rope[4]
...
# bbal_incub_ker.T
bbal_incub_ker.T_coef <- bbal_incub.fixef$Estimate[8]
bbal_incub_ker.T_CI <- paste0("[", bbal_incub.fixef$`l-95% CI`[8], "-", bbal_incub.fixef$`u-95% CI`[8], "]")
bbal_incub_ker.T_ROPE <- bbal_incub.fixef$prop_rope[8]
...
# bbal_brooding_ker.T
bbal_brooding_ker.T_coef <- bbal_brooding.fixef$Estimate[8]
bbal_brooding_ker.T_CI <- paste0("[", bbal_brooding.fixef$`l-95% CI`[8], "-", bbal_brooding.fixef$`u-95% CI`[8], "]")
bbal_brooding_ker.T_ROPE <- bbal_brooding.fixef$prop_rope[8]
...
# bbal_brooding_ker.D
bbal_brooding_ker.D_coef <- bbal_brooding.fixef$Estimate[9]
bbal_brooding_ker.D_CI <- paste0("[", bbal_brooding.fixef$`l-95% CI`[9], "-", bbal_brooding.fixef$`u-95% CI`[9], "]")
bbal_brooding_ker.D_ROPE <- bbal_brooding.fixef$prop_rope[9]

bbal_brooding_ker.D_probs <- calculate_prob_change(bbal_brooding.brms, bbal_brooding.behaviour, "diff_trip.days", c(0, 2), "kerguelen")
...
# waal_incub_cro_V
waal_incub_cro.V_coef <- waal_incub.fixef$Estimate[10]
waal_incub_cro.V_CI <- paste0("[", waal_incub.fixef$`l-95% CI`[10], "-", waal_incub.fixef$`u-95% CI`[10], "]")
waal_incub_cro.V_ROPE <- waal_incub.fixef$prop_rope[10]

waal_incub_cro.V_probs <- calculate_prob_change(waal_incub.brms, waal_brooding.behaviour, "diff_var.days", c(0,2), "crozet")
...
waal_brooding_cro.T_probs <- calculate_prob_change(waal_brooding.brms, waal_brooding.behaviour, "median_trip.days", c(1,4), "crozet")
...
# waal_brooding_cro_D
waal_brooding_cro.D_coef <- waal_brooding.fixef$Estimate[9]
waal_brooding_cro.D_CI <- paste0("[", waal_brooding.fixef$`l-95% CI`[9], "-", waal_brooding.fixef$`u-95% CI`[9], "]")
waal_brooding_cro.D_ROPE <- waal_brooding.fixef$prop_rope[9]

waal_brooding_cro.D_probs <- calculate_prob_change(waal_brooding.brms, waal_brooding.behaviour, "diff_trip.days", c(0,3), "crozet")
...
During incubation, we found strong evidence that breeding success in black-browed albatrosses increased with pair-level median trip duration ($T$) at Bird Island, and negligible evidence for an effect at Kerguelen (Table 1). The estimated effect (log-odds with 95% credible intervals) at Bird Island was  `r bbal_incub_bi.T_coef` `r bbal_incub_bi.T_CI` (proportion inside ROPE = `r bbal_incub_bi.T_ROPE`. For an increase in trip duration from 2 to 5 days, this corresponded to an approximate increase in breeding success of `r bbal_incub_bi.T_probChg` `r bbal_incub_bi.T_probCIChg` percentage points (Figure 2A). We found no strong evidence that the fasting debt ($F$), difference in trip duration ($D$), or difference in trip variability ($V$) affected breeding success during incubation.

During brooding, we found moderate evidence for a positive effect of pair-level median trip duration ($T$) on breeding success at Kerguelen, but not bird Island (interaction estimate = `r bbal_brooding_ker.T_coef` `r bbal_brooding_ker.T_CI`, proportion in ROPE = `r bbal_brooding_ker.T_ROPE`; Table 1). This equates to an approximate increase in breeding success of `r bbal_brooding_ker.T_probChg` `r bbal_brooding_ker.D_probCIChg` percentage points for an increase in trip duration from 1 to 2 days (Figure 2B). We also found moderate evidence that, in contrast, greater within-pair difference in trip duration ($D$) reduced breeding success at Kerguelen (interaction estimate = `r bbal_brooding_ker.D_coef` `r bbal_brooding_ker.D_CI`, proportion in ROPE = `r bbal_brooding_ker.D_ROPE`; Table 1), equating to a `r bbal_brooding_ker.T_probChg` `r bbal_brooding_ker.D_probCIChg` percentage point decline for an increase in duration differences from 0 to 2 days (Figure 2C). We found negligible evidence for effects of either behaviour at Bird Island, and no effects of F or V at Kerguelen. 

For wandering albatrosses, we found negligible evidence that the various pair-level foraging metrics during incubation or brooding influenced breeding success at Bird Island (Table 2). At Crozet, however, we found weak to moderate evidence that within-pair differences in trip variability ($V$) during incubation were associated with lower breeding success (interaction estimate = `r waal_incub_cro.V_coef` `r waal_incub_cro.V_CI`, proportion inside ROPE = `r waal_incub_cro.V_ROPE`; Table 2). This corresponds to an approximate decline in breeding success of `r waal_incub_cro.V_probChg` `r waal_incub_cro.V_probCIChg` percentage points for an increase in trip variability difference of 0 to 2 days (Figure 3A).

During brooding at Crozet, we found weak to moderate evidence that breeding success increased with pair-level median trip duration ($T$; interaction estimate = `r waal_brooding_cro.T_coef` `r waal_brooding_cro.T_CI`, proportion inside ROPE = `r waal_incub_cro.V_ROPE`; Table 2). This would equate to an increase of `r waal_brooding_cro.T_probChg` `r waal_brooding_cro.T_probCIChg` percentage points in breeding success for an increase in trip duration from 1 to 4 days (Figure 3B). We found strong evidence that, conversely, greater within-pair difference in trip duration ($D$) reduced breeding success (interaction estimate = `r waal_brooding_cro.D_coef` `r waal_brooding_cro.D_CI`, proportion inside ROPE = `r waal_brooding_cro.D_ROPE`; Table 2), resulting in a decline in breeding success of `r waal_brooding_cro.D_probChg` `r waal_brooding_cro.D_probCIChg` percentage points for an increase in duration differences from 0 to 3 days (Figure 3C). 
