...
"raster", "rnaturalearthdata", "ggpubr", "sp", "adehabitatHR")
...
ker_fixef <- rbind(ker_median_trip, ker_diff_trip, ker_diff_var) # ker_debt, 
...
# Combine the results with the original fixef data
cro_fixef <- rbind(cro_median_trip, cro_diff_trip, cro_diff_var) # cro_debt,
...
behav_cor_bbal.incub <- ggpairs(
  data = bbal_incub.behaviour %>% ungroup() %>%
    select(colony, median_trip_F.days, median_trip_M.days, diff_trip_FM.days, diff_var_FM.days),
  columns = 2:5,
